...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_CREATE:
	{
		...
		CreateWindow(L"edit", NULL,
			WS_CHILD | WS_VISIBLE | WS_BORDER | CBS_AUTOHSCROLL,
			10 + 100 + 10, 10, 100, 25, hWnd, (HMENU)3002, hInst, NULL);
		...
		CreateWindow(L"button", L"빼기",
			WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON,
			10 + 100 + 10, 10 + 25 + 5, 100, 25, hWnd, (HMENU)4002, hInst, NULL);

		CreateWindow(L"button", L"곱셈",
			WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON,
			10 + 200 + 20, 10 + 25 + 5, 100, 25, hWnd, (HMENU)4003, hInst, NULL);

		CreateWindow(L"button", L"나누기",
			WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON,
			10 + 300 + 30, 10 + 25 + 5, 100, 25, hWnd, (HMENU)4004, hInst, NULL);
	};
		break;
    case WM_COMMAND:
        {
			...
			case 4002:
			{
				...
				swprintf_s(szOutput, 256, L"빼기 %d ", sub);
				MessageBox(hWnd, szOutput, L"결과", MB_OK);
			...
			case 4003:
			{
				...
				swprintf_s(szOutput, 256, L"곱하기 %d ", mul);
				MessageBox(hWnd, szOutput, L"결과", MB_OK);
			...
			case 4004:
			{
				...
				swprintf_s(szOutput, 256, L"나누기 %f ", avg);
				MessageBox(hWnd, szOutput, L"결과", MB_OK);
